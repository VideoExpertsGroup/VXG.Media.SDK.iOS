...
{
    return [[MovieViewController alloc] initWithContentPath: path parameters: nil hw: hw countInstances:countInstances];
}
...
- (void) viewWillDisappear:(BOOL)animated
{
    ...
    {
        [players[i] Close];
        LoggerStream(1, @"viewWillDisappear: %@", players[i]);
    }
