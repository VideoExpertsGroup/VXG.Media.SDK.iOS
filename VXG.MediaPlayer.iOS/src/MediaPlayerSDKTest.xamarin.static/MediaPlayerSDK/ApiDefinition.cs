...
namespace MediaPlayerSDK
{
	...
	[BaseType (typeof(NSObject))]
	interface MediaPlayerPlaySegment
	{
		...
		IntPtr Constructor (MediaPlayerPlaySegment newSegment);
	}
	...
	{
		// @property (nonatomic) int contentProviderLibrary;
		[Export ("contentProviderLibrary")]
		int ContentProviderLibrary { get; set; }
		...
		[Export ("connectionSegments", ArgumentSemantic.Assign)]
		NSMutableArray ConnectionSegments { get; set; }

		// @property (nonatomic) int connectionNetworkProtocol;
		[Export ("connectionNetworkProtocol")]
		int ConnectionNetworkProtocol { get; set; }

		// @property (nonatomic) int connectionNetworkMode;
		[Export ("connectionNetworkMode")]
		int ConnectionNetworkMode { get; set; }
		...
		// @property (nonatomic) int decodingAudioType;
		[Export ("decodingAudioType")]
		int DecodingAudioType { get; set; }
		...
		// @property (nonatomic) int subRawData;
		[Export ("subRawData")]
		int SubRawData { get; set; }
		...
		// @property (nonatomic) float aspectRatioZoomModePercentAsFloat;
		[Export ("aspectRatioZoomModePercentAsFloat")]
		float AspectRatioZoomModePercentAsFloat { get; set; }

		// @property (nonatomic) float aspectRatioMoveModeXAsFloat;
		[Export ("aspectRatioMoveModeXAsFloat")]
		float AspectRatioMoveModeXAsFloat { get; set; }

		// @property (nonatomic) float aspectRatioMoveModeYAsFloat;
		[Export ("aspectRatioMoveModeYAsFloat")]
		float AspectRatioMoveModeYAsFloat { get; set; }
		...
		[Export ("startHTTPHeaders")]
		string StartHTTPHeaders { get; set; }
		...
		// @property (nonatomic) int recordFrameDuration;
		[Export ("recordFrameDuration")]
		int RecordFrameDuration { get; set; }
		...
		// @property (nonatomic) int fastDetect;
		[Export ("fastDetect")]
		int FastDetect { get; set; }

		// @property (nonatomic) int skipUntilKeyFrame;
		[Export ("skipUntilKeyFrame")]
		int SkipUntilKeyFrame { get; set; }

		// @property (nonatomic) int sendKeepAlive;
		[Export ("sendKeepAlive")]
		int SendKeepAlive { get; set; }

		// @property (nonatomic) NSString * licenseKey;
		[Export ("licenseKey")]
		string LicenseKey { get; set; }

		// @property (nonatomic) MediaPlayerLatencyPreset latencyPreset;
		[Export ("latencyPreset", ArgumentSemantic.Assign)]
		MediaPlayerLatencyPreset LatencyPreset { get; set; }

		// @property (nonatomic) int latencySpeedOver;
		[Export ("latencySpeedOver")]
		int LatencySpeedOver { get; set; }

		// @property (nonatomic) int latencySpeedOver1;
		[Export ("latencySpeedOver1")]
		int LatencySpeedOver1 { get; set; }

		// @property (nonatomic) int latencySpeedDown;
		[Export ("latencySpeedDown")]
		int LatencySpeedDown { get; set; }

		// @property (nonatomic) int latencyUpperMaxFrames;
		[Export ("latencyUpperMaxFrames")]
		int LatencyUpperMaxFrames { get; set; }

		// @property (nonatomic) int latencyUpperMaxFrames1;
		[Export ("latencyUpperMaxFrames1")]
		int LatencyUpperMaxFrames1 { get; set; }

		// @property (nonatomic) int latencyUpperNormalFrames;
		[Export ("latencyUpperNormalFrames")]
		int LatencyUpperNormalFrames { get; set; }

		// @property (nonatomic) int latencyLowerMinFrames;
		[Export ("latencyLowerMinFrames")]
		int LatencyLowerMinFrames { get; set; }

		// @property (nonatomic) int latencyLowerNormalFrames;
		[Export ("latencyLowerNormalFrames")]
		int LatencyLowerNormalFrames { get; set; }

		// @property (nonatomic) NSMutableArray * webrtcIceServers;
		[Export ("webrtcIceServers", ArgumentSemantic.Assign)]
		NSMutableArray WebrtcIceServers { get; set; }

		// @property (nonatomic) NSMutableArray * webrtcTransceiverCaps;
		[Export ("webrtcTransceiverCaps", ArgumentSemantic.Assign)]
		NSMutableArray WebrtcTransceiverCaps { get; set; }

		// @property (nonatomic) int backwardAudio;
		[Export ("backwardAudio")]
		int BackwardAudio { get; set; }
		...
		[Export ("runDisplayLinkInMainQueue")]
		int RunDisplayLinkInMainQueue { get; set; }
		...
		[Static]
		[Export ("setLogLevelForObjcPart:")]
		void SetLogLevelForObjcPart (MediaPlayerLogLevel newValue);

		// +(MediaPlayerLogLevel)getLogLevelForObjcPart;
		[Static]
		[Export ("getLogLevelForObjcPart")]
		//[Verify (MethodToProperty)]
		MediaPlayerLogLevel LogLevelForObjcPart { get; }

		// +(void)setLogLevelForNativePart:(MediaPlayerLogLevel)newValue;
		[Static]
		[Export ("setLogLevelForNativePart:")]
		void SetLogLevelForNativePart (MediaPlayerLogLevel newValue);

		// +(MediaPlayerLogLevel)getLogLevelForNativePart;
		[Static]
		[Export ("getLogLevelForNativePart")]
		//[Verify (MethodToProperty)]
		MediaPlayerLogLevel LogLevelForNativePart { get; }

		// +(void)setLogLevelForMediaPart:(MediaPlayerLogLevel)newValue;
		[Static]
		[Export ("setLogLevelForMediaPart:")]
		void SetLogLevelForMediaPart (MediaPlayerLogLevel newValue);

		// +(MediaPlayerLogLevel)getLogLevelForMediaPart;
		[Static]
		[Export ("getLogLevelForMediaPart")]
		//[Verify (MethodToProperty)]
		MediaPlayerLogLevel LogLevelForMediaPart { get; }
	...
	interface MediaPlayerCallback
	{
		...
		// @optional -(int)OnWebRTCOfferAvailable:(MediaPlayer *)player offerSDP:(NSString *)offer;
		[Export ("OnWebRTCOfferAvailable:offerSDP:")]
		int OnWebRTCOfferAvailable (MediaPlayer player, string offer);

		// @optional -(int)OnWebRTCIceCandidateAvailable:(MediaPlayer *)player iceCandidate:(NSString *)candidate sdpMLineIndex:(int)index;
		[Export ("OnWebRTCIceCandidateAvailable:iceCandidate:sdpMLineIndex:")]
		int OnWebRTCIceCandidateAvailable (MediaPlayer player, string candidate, int index);
	}
	...
	interface MediaPlayer
	{
		...
		// -(id)initWithBounds:(CGRect)bounds andGraphicLayer:(MediaPlayerGraphicLayer)layer;
		[Export ("initWithBounds:andGraphicLayer:")]
		IntPtr Constructor (CGRect bounds, MediaPlayerGraphicLayer layer);
		...
		[Export ("getPropInt64:")]
		long GetPropInt64 (MediaPlayerProperties prop);

		// -(NSString *)getPropString:(MediaPlayerProperties)prop;
		[Export ("getPropString:")]
		string GetPropString (MediaPlayerProperties prop);

		// -(char *)getPropBinary:(MediaPlayerProperties)prop buffer_size:(int32_t *)buffer_size;
		[Export ("getPropBinary:buffer_size:")]
        //unsafe sbyte* GetPropBinary (MediaPlayerProperties prop, int* buffer_size);
        unsafe IntPtr GetPropBinary(MediaPlayerProperties prop, ref int buffer_size);
		...
		[Export ("addPlaySegment:")]
		void AddPlaySegment (MediaPlayerPlaySegment segment);

		// -(void)removePlaySegment:(MediaPlayerPlaySegment *)segment;
		[Export ("removePlaySegment:")]
		void RemovePlaySegment (MediaPlayerPlaySegment segment);

		// -(int)sendBackwardAudioBuffer:(uint8_t *)buffer withSize:(int32_t)size andPts:(int64_t)pts;
		[Export ("sendBackwardAudioBuffer:withSize:andPts:")]
		//unsafe int SendBackwardAudioBuffer (byte* buffer, int size, long pts);
        unsafe int SendBackwardAudioBuffer(ref byte buffer, int size, long pts);

		// -(int)webrtcSetAnswer:(NSString *)answer;
		[Export ("webrtcSetAnswer:")]
		int WebrtcSetAnswer (string answer);

		// -(int)webrtcSetICECandidate:(NSString *)candidate withSDPMLineIndex:(int)index;
		[Export ("webrtcSetICECandidate:withSDPMLineIndex:")]
		int WebrtcSetICECandidate (string candidate, int index);
	}
