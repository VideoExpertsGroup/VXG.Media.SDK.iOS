...
- (id)init
{
    ...
    if (self) {
        ...
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"rtmp://54.173.34.172:1939/relay/demo" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"rtsp://192.168.1.40:8554/desktop" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"rtsp://192.168.1.38:5540/ch0" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"rtsp://10.20.16.59:8554/desktop" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"rtsp://10.20.16.98:5540/ch0" image:nil]];
        
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"http://10.20.16.128:81/www/5910cb801ce3d6da02c0d342.mp4" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"http://10.20.16.128:81/www/5911affe1ce3d685116798e7.mp4" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"https://vod-us-east-1.streamago.tv/15st/user/590cc8ca5f2cad58585bcfe4/stream/5910cb80e8fd6/5910cb801ce3d6da02c0d342.mp4" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"https://vod-eu-west-1.streamago.tv/14st/user/56f935d01ce3d6a2125eb63d/stream/5911affea6677/5911affe1ce3d685116798e7.mp4" image:nil]];
        [_remoteMovies addObject:[[Url alloc] initWithParam:@"rtsp://aicamtest@asus.com:f64e95ba658725b6bd551134b5e088d0@aicamtest.asuscomm.com/CH1" image:nil]];
    }
    return self;
}
